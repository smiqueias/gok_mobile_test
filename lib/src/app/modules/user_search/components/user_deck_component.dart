...
class UserDeckComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) =>  UserSearchCubit(UserSearchRepository(Modular.get(), Modular.get()), Modular.get(), username),
                         ...
                         Column(
                           ...
                           children: [
                             ...
                             Row(
                               children: [
                                 Visibility(
                                   visible: state.userModel.twitter_username != null,
                                   child: const Text("@"),
                                 ),
                                 Text(state.userModel.twitter_username ?? "Não informado"),
                               ],
                             )
                           ],
                         ),
