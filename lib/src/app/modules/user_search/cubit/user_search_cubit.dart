...
class UserSearchCubit extends Cubit<UserSearchState> {
  ...
  UserSearchCubit(this._userSearchRepository, this._log, this.username) : super(const UserSearchInitial()) {
    fetchUser(username);
  }
  ...
  Future<void> fetchUser(String username) async {
    try {
      ...
      emit(const UserSearchError("Erro ao pesquisar o uusário"));
